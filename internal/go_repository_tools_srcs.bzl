...
GO_REPOSITORY_TOOLS_SRCS = [
    ...
    Label("//v2/cmd/gazelle/update:fix-update.go"),
    ...
    Label("//v2/internal/gen_gazelle_binary_main:BUILD.bazel"),
    Label("//v2/internal/gen_gazelle_binary_main:main.go"),
    Label("//v2/internal/language:BUILD.bazel"),
    Label("//v2/internal/language/test_filegroup:BUILD.bazel"),
    Label("//v2/internal/language/test_filegroup:lang.go"),
    Label("//v2/internal/module:BUILD.bazel"),
    Label("//v2/internal/module:module.go"),
    Label("//v2/internal/version:BUILD.bazel"),
    ...
    Label("//v2/language/bazel:BUILD.bazel"),
    Label("//v2/language/bazel/visibility:BUILD.bazel"),
    Label("//v2/language/bazel/visibility:config.go"),
    Label("//v2/language/bazel/visibility:lang.go"),
    Label("//v2/language:lang.go"),
    Label("//v2/language/proto:BUILD.bazel"),
    Label("//v2/language/proto:config.go"),
    Label("//v2/language/proto:constants.go"),
    Label("//v2/language/proto:fileinfo.go"),
    Label("//v2/language/proto/gen:BUILD.bazel"),
    Label("//v2/language/proto/gen:gen_known_imports.go"),
    Label("//v2/language/proto:generate.go"),
    Label("//v2/language/proto:kinds.go"),
    Label("//v2/language/proto:known_go_imports.go"),
    Label("//v2/language/proto:known_imports.go"),
    Label("//v2/language/proto:known_proto_imports.go"),
    Label("//v2/language/proto:lang.go"),
    Label("//v2/language/proto:package.go"),
    Label("//v2/language/proto:resolve.go"),
