...
//
// For compatibility with older versions of Gazelle, the Go extension may
// also infer the proto mode (proto.ProtoConfig.Mode) based on directory names
// and contents of build files. Explicit choices by the user will not be
// overridden, but in the absence of an explicit choice, Gazelle may switch
// to legacy or disable mode.
//
// Rule generation
//
