...
// that languages are used in matters, since one language may depend on
// another (for example, go depends on proto, since go_proto_libraries are
// generated from information stored in proto_libraries).
//
...
// into Bazell labels like "@com_github_foo_bar//:go_default_library".
//
...
// be loaded.
//
// * Merging generated rules into existing rules: languages indicate which
...
type Language interface {
	...
	// c is the current configuration, after Configure has been called.
	...
	// files is a list of files that match FileSuffixes.
