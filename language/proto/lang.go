...
// importsKey is the name of a private attribute set on rules generated by
// this extension. The value is used to set deps during dependency resolution.
//
// TODO(v2): make GenerateRules use this constant.
const importsKey = "_gazelle_imports"
